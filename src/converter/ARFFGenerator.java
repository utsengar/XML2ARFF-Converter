...
public class ARFFGenerator {
  ...
  public Instances generateARFF(ArrayList<XMLValues> xmlValues) throws Exception {
    ...
    for(int i=0; i<xmlValues.size(); i++)
    {
        ...
        vals[3] = data.attribute(3).addStringValue(xmlValues.get(i).getBody()); //Body
        vals[4] = data.attribute(4).addStringValue(xmlValues.get(i).getTags()); //Tags
        
        // - date
        vals[5] = data.attribute(5).parseDate(xmlValues.get(i).getDate()); //CreationDate
